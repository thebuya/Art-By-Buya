...
function setItems(product) {
    ...
    /*
            addOneMore.addEventListener('click', () => {
                console.log("Hey");
            });*/
...
//total cost javascript // cost me 24$ 🧸
...
function displayCart() {
    ...
    startCheckout.addEventListener('click', () => {
        ...
        startCheckout.textContent = "Processing..."; // Change back ⬇ ⬇ ⬇ ⬇
        setTimeout(function () { startCheckout.textContent = " 🚧 Currently under Upgrade 🚧"; }, 2000);
...
function deleteButtons() { // cost me 24$ - #SkillShare
    ...
    for (let i = 0; i < deleteButtons.length; i++) {
        deleteButtons[i].addEventListener('click', () => {
            ...
            delete cartItems[productName].inCart;  // 💭 #Solution
